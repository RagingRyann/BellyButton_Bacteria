...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    let values = sampleArray.sample_values;
    let sortedValues = values.sort((a,b) => b-a);
    console.log(sortedValues);
    let tenVal = sortedValues.slice(0,10);
    //console.log(tenVal);

    let otuID = sampleArray.otu_ids.slice(0,10);
    let otuLabels = sampleArray.otu_labels.slice(0,10);
